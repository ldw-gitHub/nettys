...
public class TokenEncryptUtils {
    ...
    // 编码密码,可自定义
    private static final String ENCODED_PASSWORD = "netty";
     ...
     * @return
     */
    public static String encoded(String str,String encodePassword) {
        return strToHex(encodedString(str, encodePassword));
    }
